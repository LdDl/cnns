...
func CheckFClayer() {
	flayer1 := nns.NewFullConnectedLayer(2, 1, 1, 3, false)
	fullyconnected1 := &nns.LayerStruct{
		Layer: flayer1,
	}
	flayer2 := nns.NewFullConnectedLayer(flayer1.Out.X, flayer1.Out.Y, flayer1.Out.Z, 3, false)
	fullyconnected2 := &nns.LayerStruct{
		Layer: flayer2,
	}
	flayer3 := nns.NewFullConnectedLayer(flayer2.Out.X, flayer2.Out.Y, flayer2.Out.Z, 1, false)

...
func CheckOCR() {
	...
	fullyconnected2 := nns.NewFullConnectedLayer(fullyconnected.OutSize(), 44)
	fullyconnected2.SetActivationFunc(nns.ActivationSygmoid)
	fullyconnected2.SetActivationDerivativeFunc(nns.ActivationSygmoidDerivative)

	fullyconnected3 := nns.NewFullConnectedLayer(fullyconnected2.OutSize(), 22)
	fullyconnected3.SetActivationFunc(nns.ActivationSygmoid)
	fullyconnected3.SetActivationDerivativeFunc(nns.ActivationSygmoidDerivative)
